    ...
    <div class="mx-auto w-full max-w-[550px]">
        <form action="/employee/save" method="post" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" id="firstname" name="empfName" value="${emp.empfName}" class="w-full border border-gray-300 rounded-md py-2 px-4" placeholder="Enter First Name">
            </div>
            <div>
                <label for="lastname" class="mb-3 block text-base font-medium text-gray-700 dark:text-gray-200">Last Name</label>
                <input type="text" id="lastname" name="emplName" value="${emp.emplName}" class="w-full border border-gray-300 rounded-md py-2 px-4" placeholder="Enter Last Name">
            </div>
            <div>
                <label for="Position" class="mb-3 block text-base font-medium text-gray-700 dark:text-gray-200">Position</label>
                <input type="text" id="Position" name="empPosition" value="${emp.empPosition}" class="w-full border border-gray-300 rounded-md py-2 px-4" placeholder="Enter Position">
            </div>
            <div>
                <label for="Salary" class="mb-3 block text-base font-medium text-gray-700 dark:text-gray-200">Salary</label>
                <input type="text" id="Salary" name="empSalary" value="${emp.empSalary}" class="w-full border border-gray-300 rounded-md py-2 px-4" placeholder="Enter Salary">
            </div>
            <div>
                <label for="Tel" class="mb-3 block text-base font-medium text-gray-700 dark:text-gray-200">Phone Number</label>
                <input type="text" id="Tel" name="empTel" value="${emp.empTel}" class="w-full border border-gray-300 rounded-md py-2 px-4" placeholder="Enter Phone Number">
            </div>
            <div>
